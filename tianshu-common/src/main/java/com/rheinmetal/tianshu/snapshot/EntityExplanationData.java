...
public final class EntityExplanationData {
    ...
    public EntityExplanationData(String name, String typeLabel, boolean invisible, double movementSpeed, String movementSpeedLabel, CombatEstimateData meleeEstimate, CombatEstimateData rangedEstimate, List<EffectData> beneficialEffects, List<EffectData> harmfulEffects, List<String> possibleDrops, Double followRange) {
        this.name = name;
