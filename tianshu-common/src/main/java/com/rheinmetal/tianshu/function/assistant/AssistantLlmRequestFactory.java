...
public final class AssistantLlmRequestFactory {
    private static final String PURPOSE = "assistant.dialogue";

    public LlmTaskRequestPayload create(AssistantInvocationPlan plan, DialogueDeliveryPayload delivery) {
        ...
        return new LlmTaskRequestPayload(
                ...
                AssistantParticipantRegistrar.PARTICIPANT_ID,
                "world",
                List.of(),
