...
public record ConversationTurn(
    ...
    public ConversationTurn(String role, String content, long createdAt) {
        this(role, content, createdAt, new AssistantTokenEstimator().estimate(content), content == null ? 0 : content.length());
    }
    ...
    public ConversationTurn {
        ...
        estimatedTokens = estimatedTokens <= 0 ? new AssistantTokenEstimator().estimate(content) : estimatedTokens;
    }
    ...
    private static String normalizeRole(String value) {
        if ("assistant".equals(value) || "system".equals(value)) {
            return value;
        }
        return "user";
    }
