...
public final class AXSpeechBridge extends AbstractProtocolAdapter implements TianshuManagedModule {
    public static final String MODULE_ID = "module.ax_speech_bridge";
    public static final String SOURCE_ID = "module.ax_speech_bridge";

    public AXSpeechBridge(ProtocolRuntime runtime) {
    ...
    private void handleLlmStream(TianshuEnvelope envelope, ProtocolContext context) {
        ...
        TtsSpeakPayload ttsPayload = new TtsSpeakPayload(
                ...
                false,
                TtsRequestSource.AX.name().toLowerCase()
        );
