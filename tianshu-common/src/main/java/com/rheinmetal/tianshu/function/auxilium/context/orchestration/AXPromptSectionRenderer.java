...
final class AXPromptSectionRenderer {
    private AXPromptSectionRenderer() {
    }

    static String render(AXPromptBuildContext context, String key, Map<String, String> variables) {
        return context.texts().render(key, variables);
    }

    static String renderContent(AXPromptBuildContext context, String key, String content) {
    ...
    static String renderLine(AXPromptBuildContext context, String key, String variableName, String value) {
