...
public record AXMemorySnapshot(
    ...
    public AXMemorySnapshot(String persona, List<String> longTermUserMemory, List<String> conversationSummary, List<ConversationTurn> shortTermTurns) {
    ...
    public static AXMemorySnapshot empty(AXScope scope) {
        return new AXMemorySnapshot(defaultPersona(AXPromptLanguage.EN_US), List.of(), List.of(), List.of(), List.of());
    }

    public static AXMemorySnapshot empty(AXScope scope, AXPromptLanguage language) {
        return new AXMemorySnapshot(defaultPersona(language), List.of(), List.of(), List.of(), List.of());
    }
