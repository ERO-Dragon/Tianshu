...
public final class AssistantProtocolAdapter extends AbstractProtocolAdapter {
    public static final String MODULE_ID = AssistantModule.MODULE_ID;
    public static final String SOURCE_ID = AssistantModule.MODULE_ID;
    public static final String DIALOGUE_DELIVERY_CAPABILITY = "ASSISTANT.DIALOGUE_DELIVERY";
    public static final String STREAM_CHUNK_ROUTE = "ASSISTANT.STREAM_CHUNK";

    public AssistantProtocolAdapter(ProtocolRuntime runtime) {
