...
import com.rheinmetal.tianshu.client.settings.protocol.SettingsResetEvent;
import com.rheinmetal.tianshu.client.settings.protocol.SettingsSaveEvent;
import com.rheinmetal.tianshu.client.settings.protocol.SettingsValidationFailureEvent;
...
public final class SettingsCoordinator {
    ...
    private static String message(UiText message) {
