...
import com.rheinmetal.tianshu.client.api.settings.ActionTemplate;
import com.rheinmetal.tianshu.client.api.settings.ColumnTemplate;
import com.rheinmetal.tianshu.client.api.settings.ItemActionTemplate;
import com.rheinmetal.tianshu.client.api.settings.ListTemplate;
import com.rheinmetal.tianshu.client.api.settings.ModuleSettingsPanel;
import com.rheinmetal.tianshu.client.api.settings.OptionTemplate;
...
import com.rheinmetal.tianshu.client.api.settings.StatusTemplate;
import com.rheinmetal.tianshu.client.api.settings.TextBlockLevel;
import com.rheinmetal.tianshu.client.api.settings.ToggleTemplate;
...
public final class ModuleSettingsPanelModel implements ModuleSettingsPanel {
    ...
    @Override
    public ModuleSettingsPanel enable(String id, UiText label, BooleanSupplier getter, Consumer<Boolean> setter) {
        return enable(id, label, getter, setter, ALWAYS_ENABLED, ALWAYS_VISIBLE);
    }

    @Override
    public ModuleSettingsPanel enable(String id, UiText label, BooleanSupplier getter, Consumer<Boolean> setter, BooleanSupplier enabled) {
        return enable(id, label, getter, setter, enabled, ALWAYS_VISIBLE);
    }

    @Override
    public ModuleSettingsPanel enable(String id, UiText label, BooleanSupplier getter, Consumer<Boolean> setter, BooleanSupplier enabled, BooleanSupplier visible) {
        templates.add(new SettingsTemplateModel.Enable(id, label, getter, setter, enabled, visible));
        return this;
    }

    @Override
    public ModuleSettingsPanel toggles(String id, UiText title, Consumer<ToggleTemplate> builder) {
        return toggles(id, title, ALWAYS_ENABLED, ALWAYS_VISIBLE, builder);
    }

    @Override
    public ModuleSettingsPanel toggles(String id, UiText title, BooleanSupplier enabled, Consumer<ToggleTemplate> builder) {
        return toggles(id, title, enabled, ALWAYS_VISIBLE, builder);
    }

    @Override
    public ModuleSettingsPanel toggles(String id, UiText title, BooleanSupplier enabled, BooleanSupplier visible, Consumer<ToggleTemplate> builder) {
    ...
    @Override
    public ModuleSettingsPanel options(String id, UiText title, Consumer<OptionTemplate> builder) {
        return options(id, title, ALWAYS_ENABLED, ALWAYS_VISIBLE, builder);
    }

    @Override
    public ModuleSettingsPanel options(String id, UiText title, BooleanSupplier enabled, Consumer<OptionTemplate> builder) {
        return options(id, title, enabled, ALWAYS_VISIBLE, builder);
    }

    @Override
    public ModuleSettingsPanel options(String id, UiText title, BooleanSupplier enabled, BooleanSupplier visible, Consumer<OptionTemplate> builder) {
    ...
    @Override
    public ModuleSettingsPanel status(String id, UiText title, Consumer<StatusTemplate> builder) {
        return status(id, title, ALWAYS_ENABLED, ALWAYS_VISIBLE, builder);
    }

    @Override
    public ModuleSettingsPanel status(String id, UiText title, BooleanSupplier enabled, Consumer<StatusTemplate> builder) {
        return status(id, title, enabled, ALWAYS_VISIBLE, builder);
    }

    @Override
    public ModuleSettingsPanel status(String id, UiText title, BooleanSupplier enabled, BooleanSupplier visible, Consumer<StatusTemplate> builder) {
    ...
    @Override
    public ModuleSettingsPanel actions(String id, UiText title, Consumer<ActionTemplate> builder) {
        return actions(id, title, ALWAYS_ENABLED, ALWAYS_VISIBLE, builder);
    }

    @Override
    public ModuleSettingsPanel actions(String id, UiText title, BooleanSupplier enabled, Consumer<ActionTemplate> builder) {
        return actions(id, title, enabled, ALWAYS_VISIBLE, builder);
    }

    @Override
    public ModuleSettingsPanel actions(String id, UiText title, BooleanSupplier enabled, BooleanSupplier visible, Consumer<ActionTemplate> builder) {
    ...
    @Override
    public ModuleSettingsPanel compound(String id, UiText title, Consumer<OptionTemplate> options, Consumer<ActionTemplate> actions, Consumer<StatusTemplate> status) {
        return compound(id, title, ALWAYS_ENABLED, ALWAYS_VISIBLE, options, actions, status);
    }

    @Override
    public ModuleSettingsPanel compound(String id, UiText title, BooleanSupplier enabled, Consumer<OptionTemplate> options, Consumer<ActionTemplate> actions, Consumer<StatusTemplate> status) {
        return compound(id, title, enabled, ALWAYS_VISIBLE, options, actions, status);
    }

    @Override
    public ModuleSettingsPanel compound(String id, UiText title, BooleanSupplier enabled, BooleanSupplier visible, Consumer<OptionTemplate> options, Consumer<ActionTemplate> actions, Consumer<StatusTemplate> status) {
    ...
    @Override
    public <T> ModuleSettingsPanel list(String id, UiText title, Consumer<ListTemplate<T>> builder) {
        return list(id, title, ALWAYS_ENABLED, ALWAYS_VISIBLE, builder);
    }

    @Override
    public <T> ModuleSettingsPanel list(String id, UiText title, BooleanSupplier enabled, Consumer<ListTemplate<T>> builder) {
        return list(id, title, enabled, ALWAYS_VISIBLE, builder);
    }

    @Override
    public <T> ModuleSettingsPanel list(String id, UiText title, BooleanSupplier enabled, BooleanSupplier visible, Consumer<ListTemplate<T>> builder) {
    ...
    @Override
    public <T> ModuleSettingsPanel catalog(String id, UiText title, Consumer<OptionTemplate> controls, Consumer<ListTemplate<T>> list) {
        return catalog(id, title, ALWAYS_ENABLED, ALWAYS_VISIBLE, controls, list);
    }

    @Override
    public <T> ModuleSettingsPanel catalog(String id, UiText title, BooleanSupplier enabled, Consumer<OptionTemplate> controls, Consumer<ListTemplate<T>> list) {
        return catalog(id, title, enabled, ALWAYS_VISIBLE, controls, list);
    }

    @Override
    public <T> ModuleSettingsPanel catalog(String id, UiText title, BooleanSupplier enabled, BooleanSupplier visible, Consumer<OptionTemplate> controls, Consumer<ListTemplate<T>> list) {
    ...
    @Override
    public ModuleSettingsPanel text(String id, UiText text, TextBlockLevel level) {
        return text(id, text, level, ALWAYS_ENABLED, ALWAYS_VISIBLE);
    }

    @Override
    public ModuleSettingsPanel text(String id, UiText text, TextBlockLevel level, BooleanSupplier enabled) {
        return text(id, text, level, enabled, ALWAYS_VISIBLE);
    }

    @Override
    public ModuleSettingsPanel text(String id, UiText text, TextBlockLevel level, BooleanSupplier enabled, BooleanSupplier visible) {
    ...
    private static final class ToggleGroup implements ToggleTemplate {
        ...
        private ToggleGroup(String id, UiText title) {
            this.id = id;
            this.title = title;
        }

        @Override
        public ToggleTemplate toggle(String id, UiText label, BooleanSupplier getter, Consumer<Boolean> setter) {
            return toggle(id, label, getter, setter, ALWAYS_ENABLED, ALWAYS_VISIBLE);
        }

        @Override
        public ToggleTemplate toggle(String id, UiText label, BooleanSupplier getter, Consumer<Boolean> setter, BooleanSupplier enabled) {
            return toggle(id, label, getter, setter, enabled, ALWAYS_VISIBLE);
        }

        @Override
        public ToggleTemplate toggle(String id, UiText label, BooleanSupplier getter, Consumer<Boolean> setter, BooleanSupplier enabled, BooleanSupplier visible) {
    ...
    private static final class OptionGroup implements OptionTemplate {
        ...
        private OptionGroup(String id, UiText title) {
            this.id = id;
            this.title = title;
        }

        @Override
        public <T> OptionTemplate select(String id, UiText label, List<T> values, Supplier<T> getter, Function<T, UiText> labeler, Consumer<T> setter) {
            return select(id, label, values, getter, labeler, setter, ALWAYS_ENABLED, ALWAYS_VISIBLE);
        }

        @Override
        public <T> OptionTemplate select(String id, UiText label, List<T> values, Supplier<T> getter, Function<T, UiText> labeler, Consumer<T> setter, BooleanSupplier enabled) {
            return select(id, label, values, getter, labeler, setter, enabled, ALWAYS_VISIBLE);
        }

        @Override
        public <T> OptionTemplate select(String id, UiText label, List<T> values, Supplier<T> getter, Function<T, UiText> labeler, Consumer<T> setter, BooleanSupplier enabled, BooleanSupplier visible) {
            entries.add(new SettingsTemplateModel.SelectEntry<>(id, label, List.copyOf(values), getter, labeler, setter, enabled, visible));
            return this;
        }

        @Override
        public OptionTemplate text(String id, UiText label, Supplier<String> getter, Consumer<String> setter) {
            return text(id, label, getter, setter, ALWAYS_ENABLED, ALWAYS_VISIBLE);
        }

        @Override
        public OptionTemplate text(String id, UiText label, Supplier<String> getter, Consumer<String> setter, BooleanSupplier enabled) {
            return text(id, label, getter, setter, enabled, ALWAYS_VISIBLE);
        }

        @Override
        public OptionTemplate text(String id, UiText label, Supplier<String> getter, Consumer<String> setter, BooleanSupplier enabled, BooleanSupplier visible) {
            entries.add(new SettingsTemplateModel.TextEntry(id, label, getter, setter, enabled, visible));
            return this;
        }

        @Override
        public OptionTemplate slider(String id, UiText label, Supplier<Double> getter, double min, double max, Consumer<Double> setter) {
            return slider(id, label, getter, min, max, setter, ALWAYS_ENABLED, ALWAYS_VISIBLE);
        }

        @Override
        public OptionTemplate slider(String id, UiText label, Supplier<Double> getter, double min, double max, Consumer<Double> setter, BooleanSupplier enabled) {
            return slider(id, label, getter, min, max, setter, enabled, ALWAYS_VISIBLE);
        }

        @Override
        public OptionTemplate slider(String id, UiText label, Supplier<Double> getter, double min, double max, Consumer<Double> setter, BooleanSupplier enabled, BooleanSupplier visible) {
    ...
    private static final class StatusGroup implements StatusTemplate {
        ...
        private StatusGroup(String id, UiText title) {
            this.id = id;
            this.title = title;
        }

        @Override
        public StatusTemplate row(String id, UiText label, Supplier<UiText> value) {
            return row(id, label, value, ALWAYS_ENABLED, ALWAYS_VISIBLE);
        }

        @Override
        public StatusTemplate row(String id, UiText label, Supplier<UiText> value, BooleanSupplier enabled) {
            return row(id, label, value, enabled, ALWAYS_VISIBLE);
        }

        @Override
        public StatusTemplate row(String id, UiText label, Supplier<UiText> value, BooleanSupplier enabled, BooleanSupplier visible) {
    ...
    private static final class ActionGroup implements ActionTemplate {
        ...
        private ActionGroup(String id, UiText title) {
            this.id = id;
            this.title = title;
        }

        @Override
        public ActionTemplate button(String id, UiText label, Runnable action) {
            return button(id, label, SettingsButtonStyle.NORMAL, action, ALWAYS_ENABLED, ALWAYS_VISIBLE);
        }

        @Override
        public ActionTemplate button(String id, UiText label, Runnable action, BooleanSupplier enabled) {
            return button(id, label, SettingsButtonStyle.NORMAL, action, enabled, ALWAYS_VISIBLE);
        }

        @Override
        public ActionTemplate button(String id, UiText label, Runnable action, BooleanSupplier enabled, BooleanSupplier visible) {
            return button(id, label, SettingsButtonStyle.NORMAL, action, enabled, visible);
        }

        @Override
        public ActionTemplate button(String id, UiText label, SettingsButtonStyle style, Runnable action) {
            return button(id, label, style, action, ALWAYS_ENABLED, ALWAYS_VISIBLE);
        }

        @Override
        public ActionTemplate button(String id, UiText label, SettingsButtonStyle style, Runnable action, BooleanSupplier enabled) {
            return button(id, label, style, action, enabled, ALWAYS_VISIBLE);
        }

        @Override
        public ActionTemplate button(String id, UiText label, SettingsButtonStyle style, Runnable action, BooleanSupplier enabled, BooleanSupplier visible) {
    ...
    private static final class ListGroup<T> implements ListTemplate<T> {
        ...
        @Override
        public ListTemplate<T> label(Function<T, UiText> labeler) {
        ...
        @Override
        public ListTemplate<T> emptyText(UiText emptyText) {
    ...
    private static final class ItemActionGroup<T> implements ItemActionTemplate<T> {
        ...
        @Override
        public ItemActionTemplate<T> button(String id, UiText label, Consumer<T> action) {
        ...
        @Override
        public ItemActionTemplate<T> button(String id, UiText label, Consumer<T> action, Predicate<T> enabled) {
            return button(id, label, SettingsButtonStyle.NORMAL, action, enabled, itemPredicate(ALWAYS_ITEM_VISIBLE));
        }

        @Override
        public ItemActionTemplate<T> button(String id, UiText label, Consumer<T> action, Predicate<T> enabled, Predicate<T> visible) {
            return button(id, label, SettingsButtonStyle.NORMAL, action, enabled, visible);
        }

        @Override
        public ItemActionTemplate<T> button(String id, UiText label, SettingsButtonStyle style, Consumer<T> action) {
            return button(id, label, style, action, itemPredicate(ALWAYS_ITEM_ENABLED), itemPredicate(ALWAYS_ITEM_VISIBLE));
        }

        @Override
        public ItemActionTemplate<T> button(String id, UiText label, SettingsButtonStyle style, Consumer<T> action, Predicate<T> enabled) {
            return button(id, label, style, action, enabled, itemPredicate(ALWAYS_ITEM_VISIBLE));
        }

        @Override
        public ItemActionTemplate<T> button(String id, UiText label, SettingsButtonStyle style, Consumer<T> action, Predicate<T> enabled, Predicate<T> visible) {
