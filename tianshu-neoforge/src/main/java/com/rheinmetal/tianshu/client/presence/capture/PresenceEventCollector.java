...
public final class PresenceEventCollector {
    ...
    private final PresencePlatform platform;
    ...
    public PresenceEventCollector(PresenceStateStore stateStore, PresencePlatform platform) {
    ...
    public void recordAdvancementUpdate(Object nativePacket) {
        for (var payload : platform.collectAdvancementUpdate(nativePacket)) {
